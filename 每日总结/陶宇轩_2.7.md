...
- 使用yolov4训练20th数据集
- 尝试用darknet_ros 运行yolov4


## 备份

- 修改了 在/opt/ros/melodic/share/cv_bridge/cmake/cv_bridgeConfig.cmake（已改回）
...
- 当前修改
  ...
  ```
  打开 /opt/ros/noetic/share/cv_bridge/cmake/cv_bridgeConfig.cmake 文件，做以下更改：（注释掉的是源代码，后边是更改后的）
